...
export const mockDroneConsoleData: DroneConsoleData = {
  ...
  observations: [
    ...
    },
    {
      ...
      media_reference: "clip-surf-001",
      media_reference_type: "drone_clip_id",
    },
    {
      observation_id: "observation-demo-shark-sighting-1",
      mission_id: "mission-panama-city-mavlink-demo",
      drone_id: "drone-panama-city-mavlink-demo",
      timestamp: "2026-06-08T17:12:00Z",
      latitude: 30.1831,
      longitude: -85.7537,
      observation_type: "shark_sighting",
      count: 1,
      estimated_length_m: 1.8,
      probable_species: "blacktip shark",
      species_assessment_source: "operator_visual_assessment",
      ...
      recommended_surveillance_pattern: "shoreline_parallel_sweep",
      analyst_review_status: "unreviewed",
      media_reference: "clip-sighting-001",
      media_reference_type: "drone_clip_id",
    },
  ],
  feed: {
