...
INITIAL_REGIONAL_PACKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "environmental_signals": ["turtle_prey_context", "SST", "biological_events", "reef_channel_habitat", "shallow_reef_habitat", "reef_edge_habitat", "hardbottom_habitat", "sandy_bottom_habitat", "nearshore_structure_context", "habitat_visibility_context", "water_clarity_context", "turbidity_context", "sediment_runoff_visibility_context", "surf_zone_visibility_context"],
        "human_exposure_signals": ["surfing", "swimming", "diving", "tourism_exposure"],
        "surveillance_rules": ["hawaii_october_tiger_context", "sighting_cluster", "reef_channel_context", "reef_edge_context", "habitat_visibility_context", "visibility_activity_stack_context"],
        ...
        "required_access_tier": "developer",
        "features": ["hawaii_sharktober", "tiger_shark_context", "hawaii_replays", "hawaii_habitat_baseline_context", "hawaii_water_clarity_baseline_context"],
    },
    {
