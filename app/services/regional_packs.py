...
INITIAL_REGIONAL_PACKS: list[dict[str, Any]] = [
    {
        ...
        "environmental_signals": ["rainfall", "runoff", "SST", "vessel_activity", "biological_events"],
    ...
    },
    {
        ...
        "environmental_signals": ["turtle_prey_context", "SST", "biological_events"],
        "human_exposure_signals": ["surfing", "swimming", "diving", "tourism_exposure"],
        "surveillance_rules": ["hawaii_october_tiger_context", "sighting_cluster"],
        ...
        "required_access_tier": "developer",
        "features": ["hawaii_sharktober", "tiger_shark_context", "hawaii_replays"],
    },
    {
    ...
    },
    {
        ...
        "environmental_signals": ["seal_colony_context", "SST", "visibility"],
        "human_exposure_signals": ["surfing", "diving", "swimming"],
        "surveillance_rules": ["seal_colony_surf_context", "white_shark_habitat"],
