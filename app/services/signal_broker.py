...
DEFAULT_MAX_AGE_HOURS = {
    ...
    "tide_state_context": 50000,
    "tide_window_context": 50000,
    "nearshore_current_context": 50000,
    "current_direction_context": 50000,
    "current_speed_context": 50000,
    "channel_flow_context": 50000,
    "tidal_exchange_context": 50000,
    "water_clarity_context": 50000,
    "turbidity_context": 50000,
    "sediment_runoff_visibility_context": 50000,
    "surf_zone_visibility_context": 50000,
    "reef_channel_habitat": 100000,
    "shallow_reef_habitat": 100000,
    "reef_edge_habitat": 100000,
    "hardbottom_habitat": 100000,
    "submerged_vegetation_habitat": 100000,
    "sandy_bottom_habitat": 100000,
    "dropoff_habitat": 100000,
    "nearshore_structure_context": 100000,
    "habitat_visibility_context": 100000,
...
def warning_inputs_from_signals(signals: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    inputs: dict[str, Any] = {
        ...
        "hawaii_habitat_signals": [],
        "hawaii_tide_current_signals": [],
        "hawaii_water_clarity_signals": [],
    ...
    for signal in active:
        ...
        if signal_type == "weather_rainfall" and value is not None:
            ...
            inputs["hawaii_habitat_signals"].append(
                {
                    "visibility": "public",
                    "signal_type": signal_type,
                    "observed_at": signal.get("timestamp"),
                    ...
                    "risk_relevance": signal.get("risk_relevance"),
                    "pack_id": signal.get("pack_id"),
                    "baseline_only": bool(signal.get("baseline_only", True)),
                    "habitat_profile_id": signal.get("habitat_profile_id"),
                    "habitat_type": signal.get("habitat_type"),
                    "geomorphology_type": signal.get("geomorphology_type"),
                    "biological_cover_type": signal.get("biological_cover_type"),
                    "depth_band_m": signal.get("depth_band_m"),
                    "edge_context": signal.get("edge_context"),
                    "channel_context": signal.get("channel_context"),
                    "visibility_context": signal.get("visibility_context"),
                    "source_name": signal.get("source_name"),
                    "source_url_reference": signal.get("source_url_reference"),
                    "source_date": signal.get("source_date"),
                    "data_freshness_label": signal.get("data_freshness_label"),
                }
            )
        elif signal_type in {
            "tide_state_context",
            ...
            inputs["hawaii_tide_current_signals"].append(
                {
                    "visibility": "public",
                    "signal_type": signal_type,
                    "observed_at": signal.get("timestamp"),
                    ...
                    "pack_id": signal.get("pack_id"),
                    "baseline_only": bool(signal.get("baseline_only", True)),
                    "tide_current_profile_id": signal.get("tide_current_profile_id"),
                    "model_domain": signal.get("model_domain"),
                    "preferred_source": signal.get("preferred_source"),
                    "fallback_sources": signal.get("fallback_sources", []),
                    "supporting_station_source": signal.get("supporting_station_source"),
                    "tide_state": signal.get("tide_state"),
                    "tide_window": signal.get("tide_window"),
                    "nearshore_current_direction": signal.get("nearshore_current_direction"),
                    "nearshore_current_speed_class": signal.get("nearshore_current_speed_class"),
                    "channel_flow_context": signal.get("channel_flow_context"),
                    "current_convergence_context": signal.get("current_convergence_context"),
                    "tidal_exchange_context": signal.get("tidal_exchange_context"),
                    "nearshore_model_resolution": signal.get("nearshore_model_resolution"),
                    "forecast_freshness": signal.get("forecast_freshness"),
                    "station_coverage_gap": signal.get("station_coverage_gap"),
                    "regional_fallback_used": bool(signal.get("regional_fallback_used", False)),
                    "source_url_reference": signal.get("source_url_reference"),
                    "source_date": signal.get("source_date"),
            ...
            inputs["hawaii_water_clarity_signals"].append(
                {
                    "visibility": "public",
                    "signal_type": signal_type,
                    "observed_at": signal.get("timestamp"),
                    ...
                    "pack_id": signal.get("pack_id"),
                    "baseline_only": bool(signal.get("baseline_only", True)),
                    "water_clarity_profile_id": signal.get("water_clarity_profile_id"),
                    "clarity_class": signal.get("clarity_class"),
                    "turbidity_class": signal.get("turbidity_class"),
                    "runoff_visibility_context": signal.get("runoff_visibility_context"),
                    "surf_zone_visibility_context": signal.get("surf_zone_visibility_context"),
                    "preferred_source": signal.get("preferred_source"),
                    "fallback_sources": signal.get("fallback_sources", []),
                    "source_url_reference": signal.get("source_url_reference"),
                    "source_date": signal.get("source_date"),
