...
SIGNAL_TYPE_DECAY_PARAMS: dict[str, dict[str, float]] = {
    ...
    "commercial_fishing_pressure": {"half_life_hours": 12.0, "expiry_multiplier": 3.0},
    "recreational_fishing_pressure": {"half_life_hours": 12.0, "expiry_multiplier": 3.0},
    "spearfishing_activity": {"half_life_hours": 8.0, "expiry_multiplier": 3.0},
    "pier_fishing_pressure": {"half_life_hours": 72.0, "expiry_multiplier": 2.5},
    "marina_boat_pressure": {"half_life_hours": 72.0, "expiry_multiplier": 2.5},
    "dive_boat_activity": {"half_life_hours": 24.0, "expiry_multiplier": 3.0},
    "liveaboard_activity": {"half_life_hours": 24.0, "expiry_multiplier": 3.0},
    ...
    "tide_state_context": {"half_life_hours": 1440.0, "expiry_multiplier": 3.0},
    "tide_window_context": {"half_life_hours": 1440.0, "expiry_multiplier": 3.0},
    "nearshore_current_context": {"half_life_hours": 1440.0, "expiry_multiplier": 3.0},
    "current_direction_context": {"half_life_hours": 1440.0, "expiry_multiplier": 3.0},
