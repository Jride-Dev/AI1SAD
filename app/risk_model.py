...
REGIONAL_RISK_PROFILES = [
    ...
    {
        "_id": "queensland_australia",
        "region_key": "queensland_australia",
        "name": "Queensland, Australia",
        "visibility": "public",
        "center": {"name": "Far North Queensland reef coast", "geo": {"type": "Point", "coordinates": [146.45, -18.08]}},
        "local_summer_high_exposure_months": [11, 12, 1, 2, 3],
        "known_high_attention_months": [5, 6, 7],
        "dominant_species": ["tiger shark", "bull shark", "reef shark", "whaler shark"],
        "species_weights": {"tiger shark": 1.0, "bull shark": 0.9, "reef shark": 0.5, "whaler shark": 0.6},
        "species_environmental_triggers": {
            "tiger shark": {"reef_prey_context": 1.2, "warm_water": 1.1, "fishing_activity": 1.1},
            "bull shark": {"river_mouth": 1.15, "rainfall_runoff": 1.15, "warm_tropical_water": 1.1},
        },
        "species_specific_risk_factors": {
            "tiger shark": ["warm tropical reef water", "prey/carcass context", "fishing or spearfishing activity"],
            "bull shark": ["warm coastal water", "river mouths", "turbid runoff where present"],
        },
        "environmental_multipliers": {"summer": 1.1, "high_attention": 1.08, "prey_indicator": 1.08},
        "human_exposure_multipliers": {"weekend": 1.06, "beach_exposure": 1.08},
        "warning_cache_ttl_minutes": 45,
        "notes": "Queensland replay profile emphasizes tropical reef context, warm water, and tiger/bull shark operational suitability.",
        "citations": ["Australian Shark-Incident Database", "GSAF public incident records"],
    },
    {
        "_id": "california",
