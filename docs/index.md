...
<section class="ai1sad-hero">
  ...
  <aside class="ai1sad-support-card" aria-label="Support AI1SAD">
    <strong>Support AI1SAD</strong>
    <p>Sponsorship helps keep development, documentation, data cleanup, hosting, and public-safety research tooling moving.</p>
    <div class="ai1sad-support-links">
