...
- `media_reference` is an optional external identifier stored as a reference only
...
- Private fields filtered from public output
...
- Frontend: panel renders pending observations, dropdowns contain valid enum values, private notes warning is visible
